...
import type { BuiltInToolPart } from "../types";

export type ToolGroupProps = {
  part: BuiltInToolPart;
  nestedTools?: BuiltInToolPart[];
  chatStatus?: string;
...
function summarizeNestedTools(nestedTools: BuiltInToolPart[]): string {
...
function getNestedCounts(nestedTools: BuiltInToolPart[]) {
  const fileTypes = new Set(["tool-Read", "tool-Edit", "tool-Write"]);
  const searchTypes = new Set([
    "tool-Search",
    "tool-Grep",
...
export const ToolGroup = memo(function ToolGroup({
  ...
  const outputRecord =
    typeof part.output === "object" && part.output !== null
      ...
      : undefined;
  const rawOutputDuration =
    outputRecord?.totalDurationMs ??
    outputRecord?.duration ??
    outputRecord?.duration_ms;
  const outputDuration =
    typeof rawOutputDuration === "number" ? rawOutputDuration : undefined;
