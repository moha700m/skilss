...
/** Normalized input shared by the built-in agent tool renderers. */
...
/** Common shape accepted by every built-in tool renderer. */
...
/** Tool shape after the normalizer has converted structured input to an object. */
export type BuiltInToolPart = Omit<ToolPart, "input" | "args"> & {
  input?: ToolInput;
  args?: ToolInput;
};
